...
public:
    ...
    // Detect Plane from local map points
    // Returns a vector4(a, b, c, d) plane (ax + by + cz + d = 0)
    Eigen::Vector4f DetectPlane();
    ...
    void SaveDetectedPlane(const string &filename);
    ...
    // Get Plane detection module
    PlaneDetector* GetPlaneDetector();
